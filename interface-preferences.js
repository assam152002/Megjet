...
(function(){
  ...
  const tr={
    ...
    "💳 Payment":"💳 Ödeme","Cash on Delivery":"Kapıda Nakit Ödeme","Card at Doorstep (POS)":"Kapıda Kartla Ödeme (POS)",
    "Pay the rider at your door. For card, the rider brings a physical POS terminal; no card details are entered in the app.":"Kuryeye kapınızda ödeme yapın. Kart seçerseniz kurye fiziksel POS cihazı getirir; kart bilgilerinizi uygulamaya girmezsiniz.",
